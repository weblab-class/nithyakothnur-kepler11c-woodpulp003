  ...
  return (
    <>
      <div class="flex flex-row">
        ...
        <div class="flex-1">
          <div id="sound_as_waves">
            <h1 class="text-2xl">Sound waves</h1>
            <hr></hr>
            <p>
          ...
          <div id="what_is_an_envelope">
            ...
            <p>
              <p>
                Now try your hand at making ADSR changes and watch the graph evolve.
